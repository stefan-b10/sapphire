...
let ResumeContract = (_dec = NearBindgen({
  requireInit: true
}), _dec2 = view(), _dec3 = view(), _dec4 = call({
  privateFunction: true
}), _dec5 = call({
  privateFunction: true
}), _dec6 = view(), _dec7 = call({
  privateFunction: true
}), _dec8 = view(), _dec9 = call({
  privateFunction: true
}), _dec10 = view(), _dec11 = call({
  privateFunction: true
}), _dec(_class = (_class2 = class ResumeContract {
  firstName = "";
  lastName = "";
  email = "";
  phoneNumber = 0;
  education = new Vector("education");
...
}, (_applyDecoratedDescriptor(_class2.prototype, "get_first_name", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_first_name"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_last_name", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_last_name"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "change_first_name", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "change_first_name"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "change_last_name", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "change_last_name"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_email", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "get_email"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_email", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "set_email"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_phone_number", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "get_phone_number"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_phone_number", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "set_phone_number"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_education", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "get_education"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_education", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "add_education"), _class2.prototype)), _class2)) || _class);
function add_education() {
  const _state = ResumeContract._getState();
  if (!_state && ResumeContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = ResumeContract._create();
  if (_state) {
    ResumeContract._reconstruct(_contract, _state);
  }
  const _args = ResumeContract._getArgs();
  const _result = _contract.add_education(_args);
  ResumeContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ResumeContract._serialize(_result, true));
}
function get_education() {
  ...
  const _args = ResumeContract._getArgs();
  const _result = _contract.get_education(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ResumeContract._serialize(_result, true));
}
function set_phone_number() {
  ...
  const _args = ResumeContract._getArgs();
  const _result = _contract.set_phone_number(_args);
  ResumeContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ResumeContract._serialize(_result, true));
}
function get_phone_number() {
  ...
  const _args = ResumeContract._getArgs();
  const _result = _contract.get_phone_number(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ResumeContract._serialize(_result, true));
}
function set_email() {
  const _state = ResumeContract._getState();
  ...
  const _args = ResumeContract._getArgs();
  const _result = _contract.set_email(_args);
  ResumeContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ResumeContract._serialize(_result, true));
}
function get_email() {
  ...
  const _args = ResumeContract._getArgs();
  const _result = _contract.get_email(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ResumeContract._serialize(_result, true));
}
function change_last_name() {
  ...
  const _args = ResumeContract._getArgs();
  const _result = _contract.change_last_name(_args);
  ResumeContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ResumeContract._serialize(_result, true));
}
function change_first_name() {
  ...
  const _args = ResumeContract._getArgs();
  const _result = _contract.change_first_name(_args);
  ResumeContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ResumeContract._serialize(_result, true));
}
function get_last_name() {
  ...
  const _args = ResumeContract._getArgs();
  const _result = _contract.get_last_name(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ResumeContract._serialize(_result, true));
}
function get_first_name() {
  ...
  const _args = ResumeContract._getArgs();
  const _result = _contract.get_first_name(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(ResumeContract._serialize(_result, true));
}

export { add_education, change_first_name, change_last_name, get_education, get_email, get_first_name, get_last_name, get_phone_number, set_email, set_phone_number };
